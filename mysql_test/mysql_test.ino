...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://127.0.0.1:8081/IOT/getdata.php");  //--> Specify request destination
    ...
    http.begin("http://127.0.0.1:8081/IOT/updateDHT11data.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
